...
def recommend():
    ...
    array =  np.array([[ 0.31445019,  0.35496115,  0.16028048,  0.19169524,  0.28681548], \
           ...
           [ 0.50244521,  0.41742777,  0.38473318,  0.45199858,  0.49428467], \
    ...
    company = ['Adobe','Airbnb','Allstate','Apple','Boeing','Cisco','Dell', 'Expedia', \
               'Google','IBM','Indeed','Intel','JLL','KPMG','Kaiser Permanente',      \
